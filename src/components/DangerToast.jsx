...
function DangerToast({ errorMessage, onClose }) {
  ...
  return (
    <div id="toast-danger" className="fixed top-10 right-4 z-50">
      <div className="flex items-center p-4 text-textcolor bg-white rounded-lg shadow-md">
